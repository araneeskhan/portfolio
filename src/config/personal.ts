const personal = {
  ...
  githubUsername: 'araneeskhan',
  linkedin: 'https://linkedin.com/in/araneeskhan',
  linkedinHandle: '/in/araneeskhan',
  siteUrl: 'https://araneeskhan.vercel.app',
  resumePath: '/assets/Resume.pdf',
  resumeFileName: 'AneesUrRehman_Resume.pdf',
};
