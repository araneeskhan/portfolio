                ...
                <div className="mt-7">
                  ...
                  <div className="mt-3 grid gap-2.5 sm:grid-cols-2">
                    {activeService.deliverables.map((item) => (
                      <div
                        key={item}
                        className="flex items-center gap-2.5 rounded-xl border border-canvas-200/40 bg-canvas-50/60 p-2.5 text-sm font-medium text-canvas-800 dark:border-white/5 dark:bg-white/[0.03] dark:text-canvas-200"
                      >
