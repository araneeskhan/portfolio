        ...
        <div className="mt-12 max-w-4xl mx-auto">
          ...
          >
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-6">
              ...
              My journey in software development began with a curiosity about how websites work, which evolved into a 
              deep passion for building digital experiences that solve real-world problems.
            </p>
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-8">
              I specialize in both frontend and backend technologies, with expertise in React, Next.js, Node.js, and various 
              database systems. I'm constantly learning and adapting to new technologies to stay at the forefront of development.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Fresh Graduate <br />Frontend Development
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Bachelor's Degree <br />Computer Science
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Building responsive, accessible websites</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 rounded-lg mr-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-white">Mobile Development</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Creating cross-platform mobile applications</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 rounded-lg mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Building APIs and server-side applications</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 rounded-lg mr-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-white">Database Design</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Creating efficient database structures</p>
                  </div>
                </div>
              </div>
            </div>
