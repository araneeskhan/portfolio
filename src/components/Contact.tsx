  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-br from-pink-400 to-rose-600 dark:from-pink-600 dark:to-rose-900 rounded-full blur-3xl opacity-10 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div
            className="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-200/60 dark:border-gray-700/60 overflow-hidden"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            {/* Top gradient accent */}
            ...
            <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-3xl pointer-events-none"></div>
            <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="relative z-10 p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
                ...
                >
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-sky-600 to-blue-700 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <i className="fab fa-linkedin text-white text-lg"></i>
                  </div>
                  <div className="min-w-0">
                    <p className="text-xs font-semibold text-sky-500 dark:text-sky-400 uppercase tracking-wider mb-0.5">
                      LinkedIn
                    </p>
                ...
                >
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-gray-700 to-gray-900 dark:from-gray-500 dark:to-gray-700 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                {/* Location */}
                <div className="group flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-600 shadow-lg shadow-purple-500/20">
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-white/20 backdrop-blur-sm rounded-xl group-hover:scale-110 transition-transform duration-300">
                    <i className="fas fa-map-marker-alt text-white text-lg"></i>
                  </div>
                  <div className="min-w-0">
                    <p className="text-xs font-semibold text-blue-100 uppercase tracking-wider mb-0.5">
                      Location
                    </p>
              ...
              <div className="flex items-center gap-4 mb-10">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700/50 rounded-full">
                  <i className="fas fa-paper-plane text-blue-600 dark:text-blue-400 text-sm"></i>
              ...
              {state.succeeded ? (
                <div className="text-center py-16">
                  <div className="relative inline-block mb-8">
                    <div className="w-24 h-24 mx-auto flex items-center justify-center bg-gradient-to-br from-green-400 to-emerald-600 rounded-full shadow-2xl shadow-green-500/30 animate-bounce-once">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          } bg-white dark:bg-gray-700/50 text-gray-900 dark:text-white focus:outline-none transition-all duration-300`}
                    ...
                    <textarea
                      ...
                      className={`w-full px-5 py-4 rounded-2xl border-2 ${
                        focusedField === "message"
                          ? "border-blue-500 dark:border-blue-400 shadow-lg shadow-blue-500/10"
                          : "border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500"
                      } bg-white dark:bg-gray-700/50 text-gray-900 dark:text-white focus:outline-none transition-all duration-300 resize-none`}
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
                    <button
                      ...
                      className="group relative w-full sm:flex-1 py-5 px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_auto] hover:bg-right text-white font-semibold text-lg rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/40 hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none"
                    >
                      <span className="relative z-10 flex items-center justify-center">
                        {state.submitting ? (
                          ...
                          <>
                            <i className="fas fa-paper-plane mr-2 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300"></i>
                            Send Message
                          </>
                        )}
                      </span>
                    </button>
                    <div className="flex items-center gap-2 px-5 py-3 bg-green-50 dark:bg-green-900/20 rounded-2xl border border-green-200 dark:border-green-800 whitespace-nowrap">
