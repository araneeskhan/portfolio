...
export const projectsData: Record<string, Project> = {
  ...
  bankee: {
    ...
    shortDescription:
      "A mobile banking concept with wallet flows, contacts, transfers, subscriptions, and transaction history.",
    category: "Fintech",
    status: "Mobile App",
    role: "React Native developer",
    year: "2025",
    description:
      "Bankee is a modern mobile banking application built with React Native and Expo. It provides wallet management, transfer flows, transaction history, notifications, and subscription screens.",
    technologies: ["React Native", "Firebase", "Expo"],
    features: [
      "Secure authentication",
      "Wallet dashboard",
      "Contacts for sending and receiving money",
      "Easy transfers",
      "Transaction history",
